...
typedef ScanSTable = ScanStockTable;

class ScanStockTable extends StatefulWidget {
  const ScanStockTable({Key? key}) : super(key: key);

  @override
  State<ScanStockTable> createState() => _ScanStockTableState();
}

class _ScanStockTableState extends State<ScanStockTable> {
  @override
