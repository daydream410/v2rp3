...
import '../../../../../BE/resD.dart';
import '../../../../../main.dart';
import 'package:v2rp3/FE/approval_screen/purchase_approval/sppbj_approval/sppbj_app2.dart';
...
class _SppbjAppState extends State<SppbjApp> {
  ...
  void _runFilter(String enteredKeyword) {
    ...
    if (enteredKeyword.isEmpty) {
      ...
      results = dataaa
          .where((item) => item['header']['sppbjno']
              .toLowerCase()
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: ApprovalListScaffold(
        title: 'SPPBJ Approval',
        onBack: () => Get.to(const Navbar()),
        searchController: textControllers.sppbjAppController.value,
