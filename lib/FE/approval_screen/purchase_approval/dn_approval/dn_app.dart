...
import '../../../../../BE/resD.dart';
import '../../../../../main.dart';
import 'package:v2rp3/FE/approval_screen/purchase_approval/dn_approval/dn_app2.dart';
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: ApprovalListScaffold(
        title: 'D/N To Supplier Approval',
        onBack: () => Get.to(const Navbar()),
        searchController: textControllers.debitnotesAppController.value,
