...
class _SppbjConfirmState extends State<SppbjConfirm> {
  ...
  void _openDetail(dynamic item) {
    Get.to(() => SppbjConfirm2(
          seckey: item['seckey'],
          sppbjno: item['header']['sppbjno'],
          sppbjtype: item['header']['tipe'],
          tanggal: item['header']['tanggal'],
          requestorname: item['header']['requestorname'],
          warehouse: item['header']['warehousename'],
          wono: item['header']['wono'],
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: ApprovalListScaffold(
        title: 'SPPBJ Confirmation',
        onBack: () => Get.to(const Navbar()),
        searchController: textControllers.sppbjConfirmController.value,
