  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: ApprovalListScaffold(
        title: 'Stock Price Adjustment Approval',
        onBack: () => Get.to(const Navbar()),
        searchController: textControllers.stockpriceAppController.value,
