...
import '../../../../../BE/resD.dart';
import '../../../../../main.dart';
import 'package:v2rp3/FE/approval_screen/inventory_approval/sm_approval/sm_app2.dart';
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: ApprovalListScaffold(
        title: 'Stock Movement Approval',
        onBack: () => Get.to(const Navbar()),
        searchController: textControllers.smAppController.value,
