...
class _GrApp2State extends State<GrApp2> {
  ...
  List<ApprovalInfoField> _itemDetailFields(dynamic e) {
    return [
      ApprovalInfoField('PO No', (e['pono'] ?? '').toString()),
      ApprovalInfoField('Item ID', (e['itemcoa'] ?? '').toString()),
      ApprovalInfoField('Item Name & SPPBJ Remarks', (e['ket'] ?? '').toString()),
      ApprovalInfoField('Unit', (e['unit'] ?? '').toString()),
      ApprovalInfoField('QTY PO', (e['qty'].toString())),
      ApprovalInfoField('QTY Rcvd', (e['rcvd'].toString())),
      ApprovalInfoField('MU QTY', (e['qtymu'].toString())),
      ApprovalInfoField('MU WH', (e['whmu'] ?? '').toString()),
      ApprovalInfoField('IT QTY', (e['qtyit'].toString())),
      ApprovalInfoField('IT WH', (e['whit'] ?? '').toString()),
      ApprovalInfoField('QTY Stock', (e['qtystock'].toString())),
      ApprovalInfoField('WH STOCK', (e['whstock'] ?? '').toString()),
      ApprovalInfoField('QTY Cancel', (e['qtycancel'].toString())),
    ];
  }
  Widget _buildBody() {
      ...
      child: ApprovalDetailScaffold(
        ...
        infoPanel: ApprovalInfoPanel(
          ...
          fields: [
            ...
            ApprovalInfoField('Warehouse', widget.locationname ?? '-'),
          ],
        ),
